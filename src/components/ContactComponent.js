...
// Since we need to store the state of the form and our react component we need to turn this component
// into a class component. This is the only way it will be able to support controlled forms.
// function Contact (props)
class Contact extends Component {
    // Now we can store this state within our component
